...
/* 
Logic: Instead of cutting the rod, I am going to combine individual pieces into a rod 

Proceed: 
1. Its logic seems to be similar to the 0-1 Knapsack problem 
2. I can either choose to pick up a no. (if the current sum of collected lengths is less than the total sum) AND add its value 
3. Else I can choose to not pick up the no. and not add its value 
4. Even here, I have to determine the maximum cost obtained by cutting the rod into individual pieces 
5. In any stupid scenario, rod length mein se kaat ta rhunga toh usse rod length negative toh nahi hi jaayegi 
6. 
*/
