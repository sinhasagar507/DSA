...
bool areAnagram(string str1, string str2)
{
	...
	// like 'aaca' and 'aca'
	if(str1[i] and str2[i]) // This condition is used to check if a character is present at the ith index. Although a character isn't 
		return false;       // present at this index, the and condition along with it can be used to determine if an element is present 
							// at this index 
