/* Entire Linked List discussion. The primitive way. There is no explicit structure to linked list. Its entirely stored in dynamic memory(heap) */
#include<bits/stdc++.h>
using namespace std;
...
// When I don't initialize using the 'new' keyword, a pointer has just been created, and hasn't been initialized. 
